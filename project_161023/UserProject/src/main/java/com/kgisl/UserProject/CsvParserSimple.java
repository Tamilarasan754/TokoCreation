...
public class CsvParserSimple {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //URL resource = CsvParserSimple.class.getClassLoader().getResource("D:\\Tamil\\project\\UserProject\\Monitor.csv");
//File file = Paths.get(resource.toURI()).toFile();
File file = new File("D:\\Tamil\\project\\UserProject\\Monitor.csv");
