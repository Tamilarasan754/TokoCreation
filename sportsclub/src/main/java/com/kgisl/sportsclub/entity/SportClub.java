...
public class SportClub {
 ...
 @Column(name="ContactNumber")
  ...
  private List<String> SportsPreference;
...
public SportClub(Integer id, String fullName, LocalDate dateOfBirth, String gender, String address, String email,
        String contactNumber, List<String> sportsPreference, String skillLevel, String membershipType,
...
public List<String> getSportsPreference() {
    return SportsPreference;
}
public void setSportsPreference(List<String> sportsPreference) {
    SportsPreference = sportsPreference;
}
